...
def return_regular_batch(data_source_path, batch_size, aspect_to_learn):
    ...
    one_hot_depth = 6; ## 6 (count of stars, 0,1,2,3,4,5 )
    ...
    while (len(keys_list) != batch_data_length):
        ...
        # set label to proper values
        #print("value of aspect location : ", );
        #print(this_label_value);
        y_data[this_row_index, this_label_value] = 1; ## one hot encoding
